...
public class StudentPortalLogin extends SeleniumFunctions {
	...
	public void existing_student_is_on_admin_portal() {
...
//	@When("Student changes URL")
//	public void student_changes_URL(String string) throws Exception {
  // Page("LoginPage").ClearTextWithsendKeys("changeURL", enroll-to-hctp, clearExistingText, login);
