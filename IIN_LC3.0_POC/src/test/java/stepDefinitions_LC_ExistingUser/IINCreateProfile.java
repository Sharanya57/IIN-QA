...
public class IINCreateProfile extends SeleniumFunctions{
	...
	public void user_enters_email(String userEmail) throws Exception {
		
		  Page("LoginPage").clickElement("UsernameEmail");
	      Page("LoginPage").sendKeysToElement("UsernameEmail", userEmail);
	...
	public void user_enters(String DOB, String Gender, String countrycode, String Mobilenumber, String Address) throws Exception {
	  //Entering the Date of Birth 
		...
		Page("BeginWithIINEnrollment").clickElement("DirectAddressClick");
		
		//Page("BeginWithIINEnrollment").DownKeyPress();
		//Page("BeginWithIINEnrollment").EnterPress();
