...
/*
	...
	//	Boolean value=Page("SSOFunctionality").isElementPresent("TakeaTourPopup");
		if(value==true)
		{
	...
	public void Student_clicks_on_start_button() throws Exception {
		...
		Page("SSOFunctionality").clickToElementByJS("StartButtonClick");
	...
	public void Student_will_be_Navigated_to_same_module_page_which_was_outside() {
		...
		//shadowDom method
	 	// Page("SSOFunctionality").clickComplete();
	 //   Assert.assertEquals(moduleName, modulename);
	}
