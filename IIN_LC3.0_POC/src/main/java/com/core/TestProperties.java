...
public class TestProperties {
	...
	private String baseUrl_Studentlogin;
	...
	public void initProperties(){
		try {
			prop.load(new FileInputStream(PathConstants.getInstance().getBaseResourcesFolder("test.properties")));
					...
					baseUrl_Studentlogin=prop.getProperty("baseUrl_Studentlogin");
...
//					PASSWORD_ADMIN_PORTAL = prop.getProperty("PASSWORD_ADMIN_PORTAL").trim();
	...
	public String getBaseUrl_Studentlogin() {
		return baseUrl_Studentlogin;
	}
